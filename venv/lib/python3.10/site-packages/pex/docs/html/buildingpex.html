...
<link rel="index" title="Index" href="genindex.html" /><link rel="search" title="Search" href="search.html" /><link rel="next" title="PEX with included Python interpreter" href="scie.html" /><link rel="prev" title="What are .pex files?" href="whatispex.html" />
    ...
    <link rel="shortcut icon" href="_static/pex-icon.png"/><!-- Generated with Sphinx 8.2.3 and Furo 2025.07.19 -->
        <title>Building .pex files - Pex Docs (v2.46.3)</title>
...
<li class="toctree-l1"><a class="reference internal" href="api/vars.html">PEX runtime environment variables</a></li>
  ...
  <a class="muted-link" href="https://github.com/pex-tool/pex/edit/main/docs/buildingpex.rst" rel="edit" title="Edit this page">
...
<code class="docutils literal notranslate"><span class="pre">PLATFORM</span></code> is the platform (e.g. <code class="docutils literal notranslate"><span class="pre">linux-x86_64</span></code>, <code class="docutils literal notranslate"><span class="pre">macosx-10.4-x86_64</span></code> or <code class="docutils literal notranslate"><span class="pre">win-amd64`</span></code>),
<code class="docutils literal notranslate"><span class="pre">IMPL</span></code> is the python implementation abbreviation (<code class="docutils literal notranslate"><span class="pre">cp</span></code> or <code class="docutils literal notranslate"><span class="pre">pp</span></code>), <code class="docutils literal notranslate"><span class="pre">PYVER</span></code> is either a two or
more digit string representing the python version (e.g., <code class="docutils literal notranslate"><span class="pre">36</span></code> or <code class="docutils literal notranslate"><span class="pre">310</span></code>) or else a component
dotted version string (e.g., <code class="docutils literal notranslate"><span class="pre">3.6</span></code> or <code class="docutils literal notranslate"><span class="pre">3.10.1</span></code>) and <code class="docutils literal notranslate"><span class="pre">ABI</span></code> is the ABI tag (e.g., <code class="docutils literal notranslate"><span class="pre">cp36m</span></code>,
<code class="docutils literal notranslate"><span class="pre">cp27mu</span></code>, <code class="docutils literal notranslate"><span class="pre">cp38</span></code>, <code class="docutils literal notranslate"><span class="pre">abi3</span></code>, <code class="docutils literal notranslate"><span class="pre">none</span></code>). A complete example: <code class="docutils literal notranslate"><span class="pre">linux_x86_64-cp-38-cp38</span></code>.</p>
<p><strong>Constraints</strong>: when <code class="docutils literal notranslate"><span class="pre">--platform</span></code> is used the
<a class="reference external" href="https://peps.python.org/pep-0508/#environment-markers">environment marker</a>
...
corresponding to
<a class="reference external" href="https://peps.python.org/pep-0508/#environment-markers">PEP-508 marker environment</a>
...
specific last as defined in <a class="reference external" href="https://peps.python.org/pep-0425">PEP-425</a>. Pex can create

...
<link rel="index" title="Index" href="genindex.html" /><link rel="search" title="Search" href="search.html" /><link rel="next" title="PEX runtime environment variables" href="api/vars.html" /><link rel="prev" title="PEX with included Python interpreter" href="scie.html" />
    ...
    <link rel="shortcut icon" href="_static/pex-icon.png"/><!-- Generated with Sphinx 8.2.3 and Furo 2025.07.19 -->
        <title>PEX Recipes and Notes - Pex Docs (v2.46.3)</title>
...
<li class="toctree-l1"><a class="reference internal" href="api/vars.html">PEX runtime environment variables</a></li>
  ...
  <a class="muted-link" href="https://github.com/pex-tool/pex/edit/main/docs/recipes.rst" rel="edit" title="Edit this page">
...
<a class="reference external" href="https://docs.docker.com/build/building/multi-stage/">multi-stage build</a> to ensure
...
<p>For more information on the requests module support for proxies via environment variables, see the official documentation here: <a class="reference external" href="https://requests.readthedocs.io/en/latest/user/advanced/#proxies">https://requests.readthedocs.io/en/latest/user/advanced/#proxies</a>.</p>
</section>
</section>

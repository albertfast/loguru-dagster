...
<link rel="index" title="Index" href="genindex.html" /><link rel="search" title="Search" href="search.html" /><link rel="next" title="PEX Recipes and Notes" href="recipes.html" /><link rel="prev" title="Building .pex files" href="buildingpex.html" />
    ...
    <link rel="shortcut icon" href="_static/pex-icon.png"/><!-- Generated with Sphinx 8.2.3 and Furo 2025.07.19 -->
        <title>PEX with included Python interpreter - Pex Docs (v2.46.3)</title>
...
<li class="toctree-l1"><a class="reference internal" href="api/vars.html">PEX runtime environment variables</a></li>
  ...
  <a class="muted-link" href="https://github.com/pex-tool/pex/edit/main/docs/scie.md" rel="edit" title="Edit this page">
...
<code class="docutils literal notranslate"><span class="pre">scie</span></code> (pronounced like “ski”) binary powered by the <a class="reference external" href="https://github.com/astral-sh/python-build-standalone">Python Standalone Builds</a> CPython distributions or the distributions
...
-<span class="w">    </span><span class="s2">&quot;cpython-3.11.9+20240726-x86_64-unknown-linux-gnu-install_only.tar.gz&quot;</span>:<span class="w"> </span><span class="s2">&quot;https://github.com/astral-sh/python-build-standalone/releases/download/20240726/cpython-3.11.9%2B20240726-x86_64-unknown-linux-gnu-install_only.tar.gz&quot;</span>
...
:<span class="p">;</span><span class="w"> </span>curl<span class="w"> </span>-fL<span class="w"> </span>https://github.com/astral-sh/python-build-standalone/releases/download/20240726/cpython-3.11.9%2B20240726-x86_64-unknown-linux-gnu-install_only.tar.gz<span class="w"> </span>&gt;<span class="w"> </span>/tmp/example
